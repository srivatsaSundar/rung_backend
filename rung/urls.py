...
urlpatterns = [
    ...
    path('menu_availability/<str:menu_name>/', views.menu_availability, name='menu_availability'),
    path('delete_menu/<str:menu_name>/', views.delete_menu, name='delete_menu'),
    path('add_menu_germen/', views.add_menu_germen, name='add_menu_germen'),
    path('menu_availability_germen/<str:menu_name>/', views.menu_availability_germen, name='menu_availability_germen'),
    path('delete_menu_germen/<str:menu_name>/', views.delete_menu_germen, name='delete_menu_germen'),
